...
Another interesting quantity is the relative error in the data set. We are interested in finding out how much the numerical solution deviates from the analytic.
\begin{figure}[h]
  \centering
